...
## Quest: Dark Missive: Murder a generic NPC generated by the missive. (WIP)
...
## Quest: Dark Missive: Dead Drop body parts (WIP)
...
## Quest: Dark Missive: Collect Intelligence  (WIP)
...
## Quest: Dark Missive: Collect the Skooma (WIP)
...
## Quest: Dark Missive: Beat Someone Up 
  
Objective:  Hired Muscle - essentially 
  
Quest giver: any Unique NPC
...
## Quest: Dark Missive: Hunt the Thief 
...
* Pickpocketing items from NPCs (e.g X stole my wedding ring, i know he has it but the guards won't investigate!)
